...
void LODNode::autoComputeLevel(float scale)
{
    ...
    if(UserConfigParams::m_geometry_level == 0) agressivity = 2.0;
    if(UserConfigParams::m_geometry_level == 1) agressivity = 1.6;
    if(UserConfigParams::m_geometry_level == 2) agressivity = 1.25;
    if(UserConfigParams::m_geometry_level == 3) agressivity = 1.0;
    if(UserConfigParams::m_geometry_level == 4) agressivity = 0.75;
